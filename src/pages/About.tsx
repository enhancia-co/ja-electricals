    ...
    <div className="py-8 sm:py-12 md:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8 mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Welcome to JA TRD EST</h2>
        ...
        {/* Our Mission */}
        <div className="bg-gradient-to-r from-blue-600 to-orange-600 rounded-lg p-4 sm:p-6 md:p-8 text-white mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-4 sm:p-6 text-center">
                <div className="bg-gradient-to-r from-orange-500 to-blue-600 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
        ...
        {/* What We Offer */}
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8 mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">What We Offer</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Electrical Components</h3>
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Lighting Solutions</h3>
              <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
            ...
            {team.map((member, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <p className="text-orange-600 font-medium mb-2 sm:mb-3 text-sm sm:text-base">{member.role}</p>
