          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Business Avenue<br />City, State 12345</p>
            ...
            <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-lg p-8 text-white">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold">Emergency Line: +1 (555) 999-0000</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
              <p className="text-gray-600 text-center">
                <MapPin className="h-12 w-12 mx-auto mb-2 text-orange-600" />
                Interactive Map Coming Soon<br />
                <span className="text-sm">123 Business Avenue, City, State 12345</span>
              </p>
            </div>
          </div>
        </div>
